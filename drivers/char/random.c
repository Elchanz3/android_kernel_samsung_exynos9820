...
>>>>>>> 97e6ead027e6 (random: quiet urandom warning ratelimit suppression message)
...
>>>>>>> 50339a2aab7e (random: check for signals every PAGE_SIZE chunk of /dev/[u]random)
	u32 chacha_state[CHACHA20_BLOCK_SIZE / sizeof(u32)];
...
=======
=======
>>>>>>> d9a694a92c21 (random: use SipHash as interrupt entropy accumulator)
#ifdef CONFIG_SMP
/*
...
>>>>>>> 3e3d705c7e9e (random: do crng pre-init loading in worker rather than irq)
		return;
